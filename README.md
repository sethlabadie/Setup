...
### Git
[Git](https://git-scm.com) is a must-have. Install with Brew.
Also install GitHub's CLI app, gh. Install with Brew.
Also, install [GitHub CLI app, gh](https://cli.github.com) with brew. This will also add GitHub Copilot for the command line, if you have a CoPilot subscription. [Authenticate](https://docs.github.com/en/copilot/github-copilot-in-the-cli/using-github-copilot-in-the-cli) GitHub Copilot with your GitHub account.
