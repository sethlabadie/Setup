...
I would like to get a sit-stand desk. I don't have a recommendation yet. For a desk shelf, I have seen [GroveMade](https://grovemade.com) advertised quite a bit, and it looks nice. GroveMade also makes a lot of other nice desktop components.

I am not using a computer dock since I don't have a laptop, but I would choose one that has the power to connect to multiple monitors using Thunderbolt. Thunderbolt is better and faster than HDMI, and can send data both ways. Today, it looks like the [iVANKY FusionDock Max 1](https://www.amazon.com/gp/product/B0C8MZXMSR) is the best on the market. It has two Thunderbolt 4 connections for monitors. I will mount it under the desk, probably at the front edge so that I can use the SD card ports.

Since I will be docking a laptop, and I will be doing data science work, I would like to get an external GPU. No recommendations yet. I will mount it underneath the desk.

I would also like to get a KVM switch to switch between my work and personal computers.

The iMac has a built-in monitor (which is of good quality), so I don't have a separate monitor. In the future I will get a widescreen monitor, with another monitor in landscape mode to display code, my email program, or slack.
